        ...
        <DialogContent className="max-w-3xl">
          <DialogHeader>
            <DialogTitle className="font-heading flex items-center gap-3">
              <Avatar className="h-10 w-10">
                ...
                <AvatarFallback className="bg-primary text-primary-foreground">{selectedUser?.name.charAt(0)}</AvatarFallback>
              </Avatar>
              <div>
          ...
          <div className="space-y-4">
            <div className="flex gap-2">
              <Button variant="outline" size="sm"><CheckCircle className="h-3.5 w-3.5 mr-1.5" />Verify Identity</Button>
              <Button variant="outline" size="sm" className="text-destructive hover:text-destructive"><XCircle className="h-3.5 w-3.5 mr-1.5" />Suspend Account</Button>
            </div>
